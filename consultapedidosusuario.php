    ...
    <main id="main">
        <div id="contenedor" class="container mt-12">
            <div class="row">
                ...
                <div class="titulo">
                    <h1 style="color: orange;">Bienvenido a tu Espacio de Usuario <?php echo $nombre; ?></h1>
                    </div>
...
<div id="formularioad" class="container mt-4">
    ...
    <form action="consultapedidosusuario.php" method="get">
        <div class="table-responsive">
            <table class="table table-hover table-dark">
                <thead>
                    <tr>
...
function verUsuario() {
    window.location.href = "sesionusuario.php?dni=";
}
function logout() {
