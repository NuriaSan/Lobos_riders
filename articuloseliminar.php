...
<body>
    ...
    if (isset($_GET["cod_articulo"])) {
        ...
        if ($articulo) {
            ...
            echo "<form action='articuloseliminar.php' method='post'>";
    ...
    if ($resultado) {
        ...
        echo '<script type="text/javascript">setTimeout(function(){ window.location.href = "registroarticulos.php?mensaje=eliminado"; }, 0);</script>';
        exit();
    } else {
