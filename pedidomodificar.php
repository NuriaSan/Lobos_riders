                                ...
                                try {
                                    ...
                                    if ($pedido) {
                                        ...
                                        <form id="formulariomodificar" method="POST" action="">
                                            <div class="mb-3">
                                                <label for="cod_pedido" class="form-label">Codigo Pedido:</label>
                                                <input type="text" id="cod_pedido" name="cod_pedido" class="form-control"
                                                       value="<?php echo htmlspecialchars($pedido['cod_pedido']); ?>">
                                            </div>
                                            <div class="mb-3">
                                                <label for="cod_usuario" class="form-label">Codigo de Usuario:</label>
                                                <input type="text" id="cod_usuario" name="cod_usuario" class="form-control"
                                                       value="<?php echo htmlspecialchars($pedido['cod_usuario']); ?>">
                                            </div>
                                            <div class="mb-3">
