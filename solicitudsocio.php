    ...
    <main id="main">
        ...
        if (isset($_SESSION["usuario"])) {
            ...
            if ($dni) {
                ...
                if ($stmt->rowCount() > 0) {
                    echo '<a href="ordenexitosocio.php?action=placeOrder&cod_pedido=<?php echo $cod_pedido; ?>" class="btn btn-secondary m-4">Visualizar la Solicitud<i class="glyphicon glyphicon-menu-right"></i></a>';
                    echo '<a href="sesionsocio.php" class="btn btn-dark">Ir a la sesión de Usuario</a>';
                } else {
                    // Si no existe un pedido en proceso, mostrar los botones normales
                    echo '<a href="peticionmerchandisingsocio.php" class="btn btn-secondary"><i class="glyphicon glyphicon-menu-left"></i> Continuar Comprando</a>';
                }
            }
        }
        ?>
