                            ...
                            <div class="footBtn">
                                ...
                                if (isset($_SESSION["usuario"])) {
                                    ...
                                    if ($dni) {
                                        ...
                                        if ($stmt->rowCount() > 0) {
                                            echo '<a href="ordenexitosocio.php?action=placeOrder&cod_pedido=' . $cod_pedido . '" class="btn btn-secondary m-4">Visualizar la Solicitud<i class="glyphicon glyphicon-menu-right"></i></a>';
