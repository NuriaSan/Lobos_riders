...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container bg-black d-flex align-items-center justify-content-lg-between">
      ...
      <a href="logout.php" class="get-started-btn scrollto">
        <i class="fa fa-fw fa-user text-dark mr-3" style="font-size: 34px;"></i>
        <span class="position-absolute top-0 left-100 translate-middle-top badge rounded-pill bg-light text-dark"
          style="font-size: 14px;"><?php echo isset($titulo_login) ? $titulo_login : ''; ?></span>
        Log Out
      </a>
        ...
        <div class="col-md-8 mb-5">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <?php if ($mensajeExito): ?>
                <div class="alert alert-success" role="alert">&#128588; Se han modificado los datos de forma correcta
                  &#128588;</div>
              <?php endif; ?>
                  ...
                  <div class="col-md-12">
                    <div id="datosmostrados">
                      ...
                      <div id="espacioadministrador" class="mb-3">
                        <button class="btn btn-secondary w-100" type="button" onclick="mantenimientoUsuarios()">Gestión
                          de Usuarios</button>
                      </div>
                      <div id="espacioadministrador" class="mb-3">
                        <button class="btn btn-secondary w-100" type="button" onclick="registromerchandising()">Gestión
                          de Merchadising</button>
                      </div>
                      <div id="espacioadministrador" class="mb-3">
                        <button class="btn btn-secondary w-100" type="button" onclick="registropedidos()">Gestión
                          Pedidos</button>
                      </div>
                      ...
                      <script>
                        ...
                        function registromerchandising() {
                          window.location.href = "registroarticulos.php?dni=";
                        }

                        function registropedidos() {
                          window.location.href = "registropedidos.php?dni=";
                        }
