...
if (isset($_POST["confirmar"])) {
    ...
    if (Usuario::eliminarUsuario($dniUsuario)) {
        session_destroy();
        echo '<script type="text/javascript">alert("Los datos han sido eliminados"); setTimeout(function(){ window.location.href = "login.php?mensaje=eliminado"; }, 0);</script>';
        exit();
    } else {
                ...
                <div class="col-md-8 mb-5">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form id="formularioEliminar" method="POST" action="eliminarusuario.php">
                                <div class="mb-3">
                ...
                <div class="col-md-8 mb-5">
                    <div class="card">
                        <div id="accionesusuario" class="text-center p-4">
                            <div class="titulo2">
                                <h2>¿Quiere borrar su cuenta de Usuario?</h2>
                                <p>Deberá tener en cuenta que tras confirmar la eliminación no podrá acceder a su cuenta
                                    de Usuario y perderá todos sus datos.</p>
                            </div>
                            <div class="mt-4">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ¿Estás seguro de que deseas eliminar su Usuario?
                </div>
